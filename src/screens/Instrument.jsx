...
export function Instrument({ derived, actions }) {
  ...
  return (
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', background: '#f3f2f2', padding: '62px 22px 30px' }}>
      ...
      <div style={{ height: 2, background: '#201e1d', margin: '10px 0 14px' }} />
      <h2 style={{ fontSize: 32, lineHeight: 1.02, letterSpacing: '-.03em', margin: '0 0 4px' }}>{inst.name}</h2>
      <div
      ...
      <div style={{ fontSize: 11, fontWeight: 800, letterSpacing: '.1em', textTransform: 'uppercase', margin: '16px 0 6px' }}>{ii.whyThisOne}</div>
      <p style={{ fontSize: 14.5, lineHeight: 1.42, margin: '0 0 6px', color: '#201e1d' }}>{derived.readback}</p>
      <p style={{ fontSize: 14.5, lineHeight: 1.42, margin: 0, color: '#605d5d' }}>{inst.why}</p>
      <div style={{ fontSize: 11, fontWeight: 800, letterSpacing: '.1em', textTransform: 'uppercase', margin: '16px 0 6px' }}>{ii.whatItDoes}</div>
      <p style={{ fontSize: 14.5, lineHeight: 1.42, margin: 0, color: '#605d5d' }}>{inst.does}</p>
      <div style={{ height: 2, background: '#201e1d', margin: '16px 0 10px' }} />
