...
export function Home({ derived, actions }) {
  ...
  return (
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', background: '#f3f2f2', paddingTop: 58 }}>
      ...
      >
        <div style={{ fontSize: 64, lineHeight: 0.84, fontWeight: 800, letterSpacing: '-.05em', textAlign: 'center' }}>HELP!</div>
        <div style={{ fontSize: 14, fontWeight: 600, opacity: 0.86, textAlign: 'center' }}>Five questions. One Lever.</div>
      </div>
